...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_8__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_8__["default"])('[name="message"]');
  ...
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_12__["default"])('.sizes-block');
  ...
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_7__["default"])('.pageup');
...
var burger = function burger(menuSelector, burgerSelector) {
  var menuEl = document.querySelector(menuSelector),
      burgerBtn = document.querySelector(burgerSelector);
  menuEl.style.display = 'none';
  burgerBtn.addEventListener('click', function () {
    if (menuEl.style.display =  true && window.screen.availWidth < 993) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    } else if (promocodeBlock.value === 'PICASSO') {
